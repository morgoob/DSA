...
// equals()
// Returns true iff List A and List B are in same state, and returns false otherwise
// Pre: A,B != NULL, 
bool equals(List A, List B){
  if (A == NULL || B == NULL){
    fprintf(stderr, "List Error: Calling equals() on one or more NULL List reference\n");
    exit(EXIT_FAILURE);
  }
